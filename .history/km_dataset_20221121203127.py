...
# label_str = [str(i) for i in labels_list]
# with open("./basic_models/MobileViT/test/test_label.txt", "w") as f:
#   f.write(",".join(label_str))

# num = 0

# with open("./basic_models/MobileViT/test/best_vit_model_pred_result.txt") as f:
#   re = f.readlines()
# res = re[0].split(",")

# for i in range(len(res)):
#   if res[i] == str(labels[i]):
#     num+=1
# print(num/len(res))